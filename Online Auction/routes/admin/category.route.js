...
router.get('/', restrict.forUserNotAdmin, async (req, res) => {
...
router.get('/add', restrict.forUserNotAdmin, async (req, res) => {
...
router.get('/edit/:id', restrict.forUserNotAdmin, async (req, res) => {
